...
{
    private const string _privacyPolicyURL = "https://softtechhouse.co.uk/privacy/";
    private const string _termsOfUseURL = "https://softtechhouse.co.uk/terms/";
    ...
    // FullScreen
    public void ShowUrlFullScreeNoBar(string url)
    {
        GpmWebView.ShowUrl(
            url,
        ...
        GpmWebView.ShowUrl(
            ...
            new GpmWebViewRequest.Configuration()
            {
                ...
                isNavigationBarVisible =
                    true, // Показываем Navigation Bar только для страницы политики конфиденциальности
                navigationBarColor = "#4B96E6",
                title = "",
                isBackButtonVisible = false,
                isForwardButtonVisible = false,
